### test_clock_update_asm.s: Contains wrapper functions which are
...
.text
.global CALL_set_tod_from_ports
.type	CALL_set_tod_from_ports, @function
CALL_set_tod_from_ports:       
        ...
        ## movabsq $0xBADBADBADBADBADD, %rdi  # pointer to tod struct to fill
	...
	.cfi_def_cfa_offset 8   # annotate another rsp change for debugger
        ...
        ret                     
.cfi_endproc
.size CALL_set_tod_from_ports, .-CALL_set_tod_from_ports

.global CALL_set_display_from_tod
.type	CALL_set_display_from_tod, @function
CALL_set_display_from_tod:     
        ...
        movabsq $0xBADBADBADBADBADD, %rbx
        movabsq $0xBADBADBADBADBADD, %rcx
        ## movabsq $0xBADBADBADBADBADD, %rdx  # pointer to display variable
        ## movabsq $0xBADBADBADBADBADD, %rsi  # later fields of tod_t struct
        ## movabsq $0xBADBADBADBADBADD, %rdi  # first fields of tod_t struct
        ## movabsq $0xBADBADBADBADBADD, %rsp
        movabsq $0xBADBADBADBADBADD, %rbp
        movabsq $0xBADBADBADBADBADD, %r8
        movabsq $0xBADBADBADBADBADD, %r9
	...
	.cfi_def_cfa_offset 8   # annotate another rsp change for debugger
        ...
        ret                     
.cfi_endproc
.size   CALL_set_display_from_tod,.-CALL_set_display_from_tod

.global CALL_clock_update
.type	CALL_clock_update, @function
CALL_clock_update:     
        ## no arguments
        .cfi_startproc
        subq $56, %rsp          # see first function for details
	...
	.cfi_def_cfa_offset 8   # annotate another rsp change for debugger
        ...
        ret                     
.cfi_endproc
.size CALL_clock_update, .-CALL_clock_update
